...
NUTRIKA_ADMIN_ID = 8428411159     # Админ накрутки
POLINA_ID = 8428411159            # ID Поляшки
...
async def handle_message(message: Message):
    ...
    # ========== СУНДУКИ ==========
    if text == "🎁 Сундуки":
        await message.answer("🎁 Выбери сундук:\n\n📦 Обычный (100💎)\n✨ Эпический (500💎)\n🔥 Легендарный (2000💎)", reply_markup=chests_menu_kb())
        return
...
if __name__ == "__main__":
    asyncio.run(main())            "inventory": {"seed": 3, "meat": 1},
            "last_daily": None,
            "daily_quests": {},
            "achievements": [],
            "stats": {"games_played": 0, "chests_opened": 0, "pets_bought": 1, "dubli_earned": 200}
